...
#define LV_INDEV_READ_PERIOD            16                     /*Input device read period in milliseconds*/
...
#if LV_TICK_CUSTOM == 1
#define LV_TICK_CUSTOM_INCLUDE "system/systick.h"         /*Header for the sys time function*/
#define LV_TICK_CUSTOM_SYS_TIME_EXPR (System::GetTimeInMS())     /*Expression evaluating to current systime in ms*/
...
#define USE_LV_FONT_DEJAVU_10_LATIN_SUP    0//4
#define USE_LV_FONT_DEJAVU_10_CYRILLIC     0//4
#define USE_LV_FONT_SYMBOL_10              0//4

#define USE_LV_FONT_DEJAVU_20              4
#define USE_LV_FONT_DEJAVU_20_LATIN_SUP    0//4
#define USE_LV_FONT_DEJAVU_20_CYRILLIC     0//4
#define USE_LV_FONT_SYMBOL_20              0//4

#define USE_LV_FONT_DEJAVU_30              0//4
#define USE_LV_FONT_DEJAVU_30_LATIN_SUP    0//4
#define USE_LV_FONT_DEJAVU_30_CYRILLIC     0//4
#define USE_LV_FONT_SYMBOL_30              0//4

#define USE_LV_FONT_DEJAVU_40              0//4
#define USE_LV_FONT_DEJAVU_40_LATIN_SUP    0//4
#define USE_LV_FONT_DEJAVU_40_CYRILLIC     0//4
#define USE_LV_FONT_SYMBOL_40              0//4

#define USE_LV_FONT_MONOSPACE_8            0//1
